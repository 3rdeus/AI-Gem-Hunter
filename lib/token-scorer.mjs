      ...
      return {
        ...
        extensions: {
          website: heliusData.website,
                    twitter: heliusData.twitter,
          telegram: heliusData.telegram
        }
      };
    }
...
export function shouldAlert(score) {
  return score >= 50; // Lowered to 50 to capture more tokens for tracking (was 70)
}
